...
def get_parser():
    parser = argparse.ArgumentParser(
        description="Localized Phase Shift Robustness Evaluation for Full SplatTS on ETTh2"
    )

    # basic config
    parser.add_argument("--task_name", type=str, default="long_term_forecast")
    parser.add_argument("--is_training", type=int, default=0)
    parser.add_argument("--model_id", type=str, default="etth2_router_96")
    ...
    parser.add_argument("--head_dropout", type=float, default=0.85)
    ...
    parser.add_argument("--gs_dropout", type=float, default=0.85)
    ...
    parser.add_argument("--gs_residual_weight", type=float, default=0.6)
    ...
    parser.add_argument("--des", type=str, default="Ablation_ETTh2_router")
