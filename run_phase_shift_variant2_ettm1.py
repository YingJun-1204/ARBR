...
def get_parser():
    parser = argparse.ArgumentParser(description="Phase Shift Equivariance & Accuracy Evaluation (Variant 2) for ETTm1")
    ...
    parser.add_argument("--head_dropout", type=float, default=0.37364989253454384)
    ...
    parser.add_argument("--gs_dropout", type=float, default=0.5436266385439645)
    parser.add_argument("--gs_weight_decay", type=float, default=3.5693506679434546e-05)
    ...
    parser.add_argument("--gate_lambda", type=float, default=0.03704984874738518)
    parser.add_argument("--use_occlusion", action="store_true", default=False)
    parser.add_argument("--use_residual", action="store_true", default=True)
    parser.add_argument("--gs_residual_weight", type=float, default=0.21634062863393203)
    parser.add_argument("--gate_type", type=str, default="adaptive_direction")
    parser.add_argument("--gate_beta", type=float, default=0.45381630002725504)
    ...
    parser.add_argument("--learning_rate", type=float, default=0.0009824964947369181)
...
def main():
    ...
    print("\n" + "=" * 60)
    print(f" Evaluating Shift Equivariance & Accuracy for {args.model} (ETTm1) ")
    print("=" * 60)
    ...
    print("\n### 1. Shift Equivariance Error (Variant 2) Results (ETTm1)\n")
    ...
    print("\n### 2. Forecasting Accuracy (MSE / MAE) under Shift (ETTm1)\n")
