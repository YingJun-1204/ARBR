...
class Dataset_ETT_hour(Dataset):
    def __init__(self, args, root_path, flag='train', size=None,
        ...
        self.args = args
        self.seq_len, self.label_len, self.pred_len = size if size else (24*4*4, 24*4, 24*4)
    ...
    def __getitem__(self, index):
        ...
        # [优化] 直接预测目标序列，抛弃解码器所需的 label_len，节省显存
        r_begin = s_end 
        ...
        # [优化] 返回 Dummy 张量，保持向后兼容外层的 4 变量解包
        dummy_mark = torch.zeros(1)
        return seq_x, seq_y, dummy_mark, dummy_mark
...
class Dataset_Climate(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # [修复] 统一了虚拟标记，避免了当特征少于4时原有的切片报错隐患
        dummy_mark = torch.zeros(1)
        return seq_x, seq_y, dummy_mark, dummy_mark
