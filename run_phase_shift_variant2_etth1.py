...
def get_parser():
    parser = argparse.ArgumentParser(
        description="Localized Phase Shift Robustness Evaluation for Full SplatTS on ETTh1"
    )
    ...
    parser.add_argument("--head_dropout", type=float, default=0.9)
    ...
    parser.add_argument("--gs_dropout", type=float, default=0.9)
...
def main():
    ...
    for delta_t in shift_steps:
        ...
        mse, mae = evaluate_shift_metrics(
            model=exp.model,
            test_data=test_data,
